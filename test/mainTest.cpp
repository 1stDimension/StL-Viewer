...
TEST_CASE("Parser::parseFile bin PC", "[parser][full][bin]") {
    std::tuple<char *, uint64_t> reference = Loader::loadFile(
            "C:\\Users\\tooR\\Documents\\AA_Studia\\4_semestr\\Projekt indywidualny\\test\\test_bin\\exampleBin.stl");
...
TEST_CASE("Check if files are loaded correctly", "[loader][full]") {
    try {
        const std::string file = "C:\\Users\\tooR\\Documents\\AA_Studia\\4_semestr\\Projekt indywidualny\\bin\\example.stl";
